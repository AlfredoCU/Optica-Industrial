        ...
        <div class="card-body">
          <div class="row">
            <div class="col-md-6">
              ...
              <p class="text-muted"><strong> Óptica Industrial López Cotilla: </strong> (33) 3614 2007 </p>
              <div class="mapico mb-3"> 
                <i class="fas fa-envelope"></i>
              </div>
              <p class="text-muted mt-3"><strong> Email 1: </strong> opticaindustrial@hotmail.com </p>
              <p class="text-muted mt-3"><strong> Email 2: </strong> optica569@hotmail.com </p>
