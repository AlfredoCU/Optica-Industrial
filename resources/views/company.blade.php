    ...
    <div class="col-md-9">
      <div class="my-4 text-justify">
        ...
        <ul class="list-group ml-4">
          ...
          <li class="mb-1 text-muted text-justify"><strong> Descuento especial del 15%: </strong> a los empleados de su empresa y sus familiares, el descuento que convenimos con ustedes nunca es aplicable al público en general, pues es exclusivo de los empleados y familiares directos de las empresas e instituciones que nos favorecen con su preferencia. </li>
          ...
          <li class="mb-1 text-muted text-justify"><strong> Lentes de contacto: </strong> se entregarán con paquete de iniciación, el cual tendrá solución y estuche. Los cuales se enseña al cliente su correcto manejo y cuidados. Nosotros les damos garantía en su lente de contacto, y en la compra de estos puede adquirir solución para su lente cuando lo necesite, sin ningún costo. </li>
          <li class="mb-1 text-muted text-justify"><strong> Mantenimiento: </strong> ajuste, limpieza y reparación postventa, sin costo alguno. </li>
  ...
  <div class="col-md-12 d-flex justify-content-center">
    <div class="card-deck mb-3">
      ...
      <div class="card mb-4 shadow-sm">
        ...
        <div class="card-body">
          <h3 class="card-title"> MXN desde $800.00 a $1,300.00 </h3>
          <ul class="text-muted mt-3 mb-4">
      ...
      <div class="card mb-4 shadow-sm">
        ...
        <div class="card-body">
          <h3 class="card-title"> MXN desde $1,000.00 a $1,600.00 </h3>
          <ul class="text-muted mt-3 mb-4">
            <li> Armazon oftalmico de línea varias marcas y modelos de goma, acetato y metálicos. </li>
